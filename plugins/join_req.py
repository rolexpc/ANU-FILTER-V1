...
@Client.on_message(filters.command("delsub") & filters.user(ADMINS) & filters.private)
...
@Client.on_message(filters.command("get_sub") & filters.user(ADMINS) & filters.private)
